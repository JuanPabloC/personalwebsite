...
let resumeJobs = {
  ...
  uofr: {
    ...
    roles: [
      "Peer Advisor - Computer Science Department",
      "Student Worker - Hajim School of Engineering Dean's Office",
      "Teacher Assistant - Computer Science Department",
      "Resident Advisor - Residential Life"
    ]
  }
}
